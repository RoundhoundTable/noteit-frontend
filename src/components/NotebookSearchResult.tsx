      ...
      <div className="flex flex-row justify-evenly">
        <div className="flex flex-row justify-between w-full mb-4">
          <div className="flex flex-row items-center">
            ...
            <div className="ml-2">
              <h2 className="text-primary-800 text-base font-medium">
                {data.name}
              </h2>
        ...
        <div className="flex flex-row justify-around">
          <div>
            ...
            <button
              ...
              className={
                joined
                  ? "bg-primary-400/70 rounded font-semibold text-sm text-white/70 relative inline-block w-20 md:h-7 md:w-32"
                  : "bg-primary-400 rounded font-semibold text-sm text-white relative inline-block w-20 md:h-7 md:w-32"
              }
            >
